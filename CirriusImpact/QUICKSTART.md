...
- ⚠ SMSSendDriver preference not set → **You'll set this in Step 4 below**

### Step 4: Configure Koha System Preference
...
### Step 5: Configure Notice Templates

**Important:** SMS, Phone, Email, and WhatsApp are **separate notice definitions** in Koha. Create separate notices for each transport type.
...
This is already done in Step 3 above! The verification confirms:
...
**Note:** If you see "1 warning(s)" about the archive directory - that's normal! The directory is created automatically on first run.
...
- ✅ Accepts: 7325861275, (732) 586-1275, +1 732 586 1275, +44...

...
3. [HOLD Notices](#hold-notices)
   - [HOLDDGST Automatic Digest Grouping (v1.1.13)](#option-4-holddgst---automatic-digest-grouping-v1113)
...
**Example output:**
```
Centerville - Items checked out: Learning SQL (due 10/25/2025); The poems (due 10/25/2025); The bible (due 10/25/2025). Questions? Call 555-0100
```
...
Return on time to avoid fines. Questions? 555-0100
```
...
**Example output:**
```
Centerville - 3 hold(s) ready: Learning SQL; The poems; The bible. Pickup at Centerville. Questions? 555-0100
```

---

### Option 4: HOLDDGST - Automatic Digest Grouping (v1.1.13)

**🆕 NEW FEATURE:** The plugin automatically groups multiple individual HOLDDGST messages into single digest messages, even when Koha creates separate messages for each hold.

**How it works:**
1. **Koha creates individual messages** for each hold (normal behavior)
2. **Plugin detects HOLDDGST messages** and groups them by patron and transport
3. **Combines titles** with semicolons (e.g., "The poems; Learning SQL")
4. **Updates message text** to show digest format
5. **Outputs single digest message** in CSV instead of multiple individual messages
...
- ✅ **Combined titles** - Multiple items shown in single message
- ✅ **Updated message text** - Shows digest format in CSV
- ✅ **Patron salutation** - STAB_userSaluation populated (Mr./Ms.)
- ✅ **Transport-specific** - Groups by SMS, Phone, Email separately
...
• The poems
• The bible
Pick up by 10/18/2025. Questions? 555-0100
```
...
Phone: "Hello [% borrower.firstname %]. Centerville. Overdue: Learning SQL due 10/05/2025. Current fine: $2.50. Return immediately. 555-0100."
```
...
Phone: "Hello Yossi. Centerville. The poems is due 10/15/2025. Please return or renew. Call 555-0100."
```

**Digest PREDUEDGST:**
```
SMS: "CPL: 3 items due soon: The poems; Learning SQL /; The bible :. Due 10/15/2025. Please return or renew."
Phone: "Hello Yossi. Centerville. You have 3 items due soon: The poems, Learning SQL /, The bible :. Due 10/15/2025. Please return or renew. Call 555-0100."
```
...
Phone: "Hello Example User. Centerville. Your hold for The Great Gatsby has changed status. Please check your account for details. Call 555-0100."
```
...
Phone: "Hello Example User. Centerville. 3 holds have changed status: The Great Gatsby, To Kill a Mockingbird, 1984. Please check your account for details. Call 555-0100."
```

**HOLD_REMINDER (Single):**
```
SMS: "CPL: Reminder: You have a hold for The Great Gatsby ready for pickup. Expires 10/20/2025."
Phone: "Hello Example User. Centerville. Reminder: You have a hold for The Great Gatsby ready for pickup. Expires 10/20/2025. Call 555-0100."
```
...
Phone: "Hello Example User. Centerville. Reminder: You have 2 holds ready for pickup: The Great Gatsby, To Kill a Mockingbird. Expires 10/20/2025. Call 555-0100."
```

**MEMBERSHIP_EXPIRY:**
```
SMS: "CPL: Your membership expires 12/31/2025. Please renew to continue using library services."
Phone: "Hello Jane. Centerville. Your membership expires 12/31/2025. Please renew to continue using library services. Call 555-0100."
```

**RENEWAL (Single):**
```
SMS: "CPL: Learning SQL has been renewed. New due date: 11/15/2025."
Phone: "Hello Bob. Centerville. Learning SQL has been renewed. New due date: 11/15/2025. Call 555-0100."
```

**RENEWALGST (Digest):**
```
SMS: "CPL: 3 items have been renewed: Learning SQL; The Great Gatsby; To Kill a Mockingbird. New due date: 11/15/2025."
Phone: "Hello Bob. Centerville. 3 items have been renewed: Learning SQL, The Great Gatsby, To Kill a Mockingbird. New due date: 11/15/2025. Call 555-0100."
```

**WELCOME:**
```
SMS: "CPL: Welcome to Centerville! Your library card number is 1234567890. Visit us soon!"
Phone: "Hello Alice. Welcome to Centerville! Your library card number is 1234567890. We're excited to have you as a member. Call 555-0100."
```
...
patron: [% borrowernumber %]
call:
  script: "Hello [% borrower.firstname %]. [% branch.branchname %]. Credit of $[% account.amount %] applied to your account. Description: [% account.description %]. New balance: $[% account.amountoutstanding %]. Call 555-0100."
---
```
...
patron: [% borrowernumber %]
call:
  script: "Hello [% borrower.firstname %]. [% branch.branchname %]. Charge of $[% account.amount %] added to your account. Description: [% account.description %]. Outstanding balance: $[% account.amountoutstanding %]. Call 555-0100."
---
```
...
patron: [% borrowernumber %]
call:
  script: "Hello [% borrower.firstname %]. [% branch.branchname %]. Payment of $[% account.amount %] received. Description: [% account.description %]. Outstanding balance: $[% account.amountoutstanding %]. Call 555-0100."
---
```
...
patron: [% borrowernumber %]
call:
  script: "Hello [% borrower.firstname %]. [% branch.branchname %]. Account write-off of $[% account.amount %] processed. Description: [% account.description %]. Outstanding balance: $[% account.amountoutstanding %]. Call 555-0100."
---
```
...
patron: [% borrowernumber %]
call:
  script: "Hello [% borrower.firstname %]. [% branch.branchname %]. Account Summary - Outstanding balance: $[% account.total_balance %]. [% account.transaction_count %] outstanding transactions. Please pay at your convenience. Call 555-0100."
---
```
...
patron: [% borrowernumber %]
call:
  script: "Hello [% borrower.firstname %]. [% branch.branchname %]. Hold placed for [% biblio.title %]. You will be notified when ready for pickup. Expires [% hold.expirationdate | $KohaDates %]. Call 555-0100."
---
```
...
Phone: "Hello Example User. Centerville. Credit of $5.00 applied to your account. Description: Refund for lost item found. New balance: $2.50. Call 555-0100."
```

**ACCOUNT_DEBIT:**
```
SMS: "CPL: Charge of $15.00 added to your account. Description: Lost item replacement fee. Outstanding balance: $15.00."
Phone: "Hello Jane. Centerville. Charge of $15.00 added to your account. Description: Lost item replacement fee. Outstanding balance: $15.00. Call 555-0100."
```

**ACCOUNT_PAYMENT:**
```
SMS: "CPL: Payment of $10.00 received. Description: Cash payment. Outstanding balance: $5.00."
Phone: "Hello Bob. Centerville. Payment of $10.00 received. Description: Cash payment. Outstanding balance: $5.00. Call 555-0100."
```

**ACCOUNTS_SUMMARY:**
```
SMS: "CPL: Account Summary - Outstanding balance: $25.50. 3 outstanding transactions. Please pay at your convenience."
Phone: "Hello Alice. Centerville. Account Summary - Outstanding balance: $25.50. 3 outstanding transactions. Please pay at your convenience. Call 555-0100."
```

**HOLDPLACED:**
```
SMS: "CPL: Hold placed for The Great Gatsby. You will be notified when ready for pickup. Expires 10/20/2025."
Phone: "Hello Tom. Centerville. Hold placed for The Great Gatsby. You will be notified when ready for pickup. Expires 10/20/2025. Call 555-0100."
```
...
| `branch.branchphone` | Library phone | 555-0100 |

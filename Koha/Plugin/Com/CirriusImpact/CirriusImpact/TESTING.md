...
```bash
cd /var/lib/koha/library/plugins/Koha/Plugin/Com/CirriusImpact
...
✓ Regional phone number accepted: 555-0100
```
...
Expected CSV line:
```csv
S,default,CHECKOUT,,01234567890,,Y,T,555-0102,example2@example.com,CPL,Centerville,413,2025-10-18 23:59:00,The poems,,,,,52,,29,1,,
```
...
Example:
```csv
V,default,CHECKOUT,,001,,T,R,555-0100,example1@example.com,CPL,Centerville,413,2025-10-18,The poems,,,,,51,,,,,
```
...
```bash
grep "our \$VERSION" /var/lib/koha/library/plugins/Koha/Plugin/Com/CirriusImpact/CirriusImpact.pm
...
3. Check plugin version:
   ```bash
   grep VERSION /var/lib/koha/library/plugins/Koha/Plugin/Com/CirriusImpact/CirriusImpact.pm
   ```
